...
const transferFunds = async () => {
  await inquirer
    ...
    .then(async(answers) => {
      console.log(
        `Transferred amount: $${answers.amount} to ${answers.recipient}`
      );
...
const confirmTransaction = async (amount: number,type:number) => {
...
const transactionSuccess = (amount:number,type:number) => {
